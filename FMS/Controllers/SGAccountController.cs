    ...
    public class SGAccountController : BaseController
    {
        ...
        public ActionResult ForgotPassword(ForgotPasswordViewModel model)
        {
            ...
            try
            {
                ...
                msg.From = new MailAddress(ConfigSettings.SecurityGuardEmailFrom);
                msg.To.Add(model.Email);
                msg.Subject = ConfigSettings.SecurityGuardEmailSubject;
                msg.Body = body;
                msg.Priority = MailPriority.High;

                SmtpClient client = new SmtpClient();

                client.Credentials = new NetworkCredential("foodcorpindia@gmail.com", "FMS@123$", "smtp.gmail.com");
